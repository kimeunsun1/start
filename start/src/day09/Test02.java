...
//		abc();
	...
	public int calc(int no1, int no2) {
		...
		result = no1 + no2;
		// 반환값 내보내고...
		return result;	// ==>	1. 실행중인 이 함수를 즉시 종료하세요. 
...
//		return; 
	...
	public void toPrint(int no1, int no2, int no3) { // void/ String 등 가능
		// 참고 ]
		//		매개변수리스트에 정의된 변수는 이 함수에서만 사용할 수 있는 지역변수다.
		// 함수의 오버로딩(함수의 중첩)
		/*
		 	함수의 오버로딩
