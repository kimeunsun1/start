 ...
 */
	...
	public void getJobInfo(Scanner sc) {
		 ...
		 */
		// 메세지 출력하고
		System.out.print("조회할 직급을 입력하세요! 이전단계는 quit 을 입력하세요!\n직급이름 : ");
		// 직급 입력받고
	...
	public void getAll() {
		...
		try {
			...
			String url = "jdbc:oracle:thin:@172.30.1.53:1521:xe";
//			String url = "jdbc:oracle:thin:@localhost:1521:xe"; --> localhost로도 작동됨.
			String user = "scott";
			String pw = "tiger";
			con = DriverManager.getConnection(url, user, pw);
			// 질의명령 준비하고
//			String sql = getSQL(SEL_ALL); 
//			MemberSQL eSQL = new MemberSQL(); // 먼저 객체로 만들고
