...
/*
 	파라미터로 전달된 문자열
 		http://www.blackpink.org/member/?id=euns&pw=12345&tel=01031759042 // ? 이후를 파라미터라고 한다.
...
public class Test01 {
	...
	public Test01() {
		...
		// ? 기호의 위값을 알아낸후 그 바로 다음 위치에서부터 끝까지 잘라내면 된다.
		int idx = url.indexOf('?');
		String param = url.substring(idx + 1);	// "id=euns&pw=12345&tel=01031759042"
...
//			i++;
		...
		*/
		...
		/*
		 	반복문에서 조건식의 의미는 반복 횟수의 컨트롤에 의미가 있다.
		 */
