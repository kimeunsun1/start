...
public class Test11 {
	...
	public Test11() {
		...
		try {
			...
			ps.println("Make 'em whistle like a missile, bomb, bomb");
			ps.println("Every time I show up, blow up, uh");
			ps.println("소스: Musixmatch");
			ps.println("작사: Rebecca Rose Johnson / Hong Jun Park / Sunny Boy");
			ps.println("휘파람 가사 © Yg Entertainment, Bekuh Boom Publishing, Avex Music Publishing Inc");
